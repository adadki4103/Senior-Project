...
import static com.gluonapplication.Main.MENU_LAYER;
import static com.gluonapplication.Main.LANDING_VIEW;
import static com.gluonapplication.Main.WELCOME_VIEW;
...
public class DrawerManager {
    ...
    public DrawerManager() {
        ...
        final Item landingItem = new ViewItem("Home", MaterialDesignIcon.HOME.graphic(), WELCOME_VIEW, ViewStackPolicy.SKIP);
       // final Item sendGift = new ViewItem("Send a Gift", MaterialDesignIcon.FAVORITE.graphic(), SIXTH_VIEW);
        drawer.getItems().addAll(landingItem);
